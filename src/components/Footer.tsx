        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-2 mb-4">
              <img src="/src/assets/logo.png" alt="CrowdSense" className="w-8 h-8 rounded" />
              <span className="font-bold text-xl text-foreground">CrowdSense</span>
            </a>
            <p className="text-muted-foreground mb-6 max-w-xs">
              Smart crowd intelligence platform for real-time monitoring and analytics.
            </p>
